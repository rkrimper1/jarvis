...
import (
	...
	agentgw    "github.com/rkrimper1/jarvis/gen/agent"
	businessgw "github.com/rkrimper1/jarvis/gen/business"
	facilitygw "github.com/rkrimper1/jarvis/gen/facility"
	hardwaregw "github.com/rkrimper1/jarvis/gen/hardware"
	intelliggw "github.com/rkrimper1/jarvis/gen/intelligence"
	learninggw "github.com/rkrimper1/jarvis/gen/learning"
	nlpgw      "github.com/rkrimper1/jarvis/gen/nlp"
	securitygw "github.com/rkrimper1/jarvis/gen/security"
	voicegw    "github.com/rkrimper1/jarvis/gen/voice"
...
func New(ctx context.Context, cfg *config.Config, log *slog.Logger) (*Proxy, error) {
	...
	registrations := []registration{
		...
		{
			name: "voice-service",
			addr: cfg.Upstreams.VoiceService,
			register: func(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
				return voicegw.RegisterVoiceServiceHandler(ctx, mux, conn)
			},
		},
	}
